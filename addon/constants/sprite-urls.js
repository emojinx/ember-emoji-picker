export const spriteUrlsSvg = {
  ...
  noto: {
    single: 'https://cdn.jsdelivr.net/npm/@svgmoji/noto@0.2.0/svg',
    group: 'https://cdn.jsdelivr.net/npm/@svgmoji/noto/sprites/group',
    subgroup: 'https://cdn.jsdelivr.net/npm/@svgmoji/noto/sprites/subgroups',
    all: 'https://cdn.jsdelivr.net/npm/@svgmoji/noto/sprites/all.svg',
  },
  openmoji: {
